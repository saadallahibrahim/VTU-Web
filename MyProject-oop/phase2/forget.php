...
<head>
    ...
    <link rel="stylesheet" href="forgetting.css">
</head>
<body>
    ...
    <section class="form">
        <div class="form_box">
            <h1>forget password? fill up the below form</h1>
            <form method="POST" action="./Controller/user-auth/userAuth.php">
                <input type="email" placeholder="N@gmail.com" name="email">
                <input type="submit" value="submit" name="send_token" id="register">
            </form>
        </div>
    </section>
    <!--
